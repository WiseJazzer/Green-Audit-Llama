...
class GreenAuditChatbotGUI:
    def __init__(self, root):
        ...
        self.evaluate_button = tk.Button(button_frame, text="Enviar", command=self.evaluate_text, bg="#459f2e", fg="white")
        self.evaluate_button.grid(row=0, column=0, padx=5)

        self.clear_button = tk.Button(button_frame, text="Limpiar", command=self.clear_fields, bg="#459f2e", fg="white")
